  ...
  return (
    <div className="flex">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <div className="w-48 h-56 rounded-[40px] border-[28px] border-fuchsia-600 absolute top-[30%] -right-10" />
        ...
        <img
          src={CARD_2}
          className="w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15 z-20 pointer-events-none bg-white"
        />
      </div>
    </div>
  );
