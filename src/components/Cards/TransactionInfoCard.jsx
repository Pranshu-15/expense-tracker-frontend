...
//               <button 
//                 className='text-red-400 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-all duration-200 cursor-pointer p-1 rounded hover:bg-red-50'
//                 onClick={onDelete}
//               >
//                 <LuTrash2 size={18} />
//               </button>
      ...
      <div className="group relative flex items-center gap-4 mt-2 p-3 rounded-lg hover:bg-gray-100 transition-colors duration-200">
        ...
        <div className='flex-1 flex items-center justify-between'>
          ...
          <div className='flex items-center gap-2'>
            {!hideDeleteBtn && onDelete && (
              <button 
                className='text-red-400 hover:text-red-500 hover:shadow-lg hover:shadow-red-200 transition-all duration-200 cursor-pointer p-1 rounded hover:bg-red-50'
                onClick={onDelete}
              >
                <LuTrash2 size={18} />
              </button>
